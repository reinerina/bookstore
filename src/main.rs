...
use bookstore::controller::{
    admin_login, admin_register, book_detail, book_list, credit_rule, login, order_create,
    order_detail, order_history, register, supplier_profile, user_detail, user_logout,
};
